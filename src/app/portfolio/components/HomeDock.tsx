  ...
  return (
    <div className="fixed bottom-10 w-full">
      <Dock>
        ...
        <DockIcon>
            <a href="https://github.com/n8thantran" target="_blank" rel="noopener noreferrer">
                <Icons.gitHub className="size-6" />
            </a>
        </DockIcon>
        <DockIcon>
            <a href="https://www.linkedin.com/in/nthntrn/" target="_blank" rel="noopener noreferrer">
